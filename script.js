...
customerDetailsForm.addEventListener('submit', e => {
  ...
  const handler = PaystackPop.setup({
      key: 'pk_test_112a19f8ae988db1be016b0323b0e4fe95783fe8', // Your Paystack public key
      email: customerEmail,
...
document.getElementById('close_checkout').addEventListener('click', function() {
  document.getElementById('checkout').classList.add('hidden'); // Hides the checkout section
});
